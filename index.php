...
if (session_status() === PHP_SESSION_NONE) {
  ...
  <header style=" position: sticky; top: 0; display: flex; justify-content: space-between; align-items: center; padding: 10px 30px; background-color: #f5f5f5; border-bottom: 1px solid #ddd;">
    ...
    <div style="display: flex; gap: 15px;">
        ...
        <?php else: ?>
            <a href="inscription.php" style="text-decoration: none; padding: 8px 15px; background-color: #2D6DF6; color: white; border-radius: 5px;">Inscription</a>
            <a href="connexion.php" style="text-decoration: none; padding: 8px 15px; background-color: transparent; border: 1px solid #2D6DF6; color: #2D6DF6; border-radius: 5px;">Connexion</a>
            <?php endif; ?>
    </div>
</header>
